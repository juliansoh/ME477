...
between the two velocities was used to compute a control signal that was sent to the amplifier and the plant driving the motor to adjust its speed, hence
